...
*Dernière mise à jour : 4 mai 2026 — fin de session « refonte page Performance + maj types restos ».*
...
| Inventaire | Saisie inline par lieu (bar/réserve) |
| Historique inventaire | Snapshots mensuels figés |
| Performance | **Refondu — sélecteur période (semaine/mois/trim/an) + blocs CA & Ratios** |
...
> Note : le CA théorique reste **saisi à la main** pour l'instant. Lien automatique `fiches_techniques × ventes` non encore branché — chantier futur identifié.
...
**Session du 4 mai 2026 (commit `90a9273`)**
...
*Document mis à jour le 4 mai 2026 — projet Zaiko commercialisable, charte appliquée strictement, modules complets, page Performance par période en place.*
